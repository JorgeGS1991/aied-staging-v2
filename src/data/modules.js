    ...
    subTopics: [
      {
        ...
        points: 100,
        creationDate: new Date(2023, 4, 19),
        content:
          "<h1>Welcome from all of us at Work-Learn!</h1><p>We are interested in helping people like you gain new skills and expanding the opportunities you have entering (or re-entering) careers in computer and information technology. To accomplish this goal, we need to learn about who you are and what your experiences are while you are in the program.</p><h2>This will happen in a couple of ways:</h2><ol><li>Complete the Qualtrics Survey linked below to provide us with some background information about you and your past education experiences. The answers to this survey are confidential. Your name will not be used so no one will know who you are. All information about you will be kept in locked offices of the research team and information kept on computers will be password protected.</li><li>Schedule a time to meet with a member of our team either in person or online. This will be the first of three meetings you will have with a Work-Learn team member as you move through the program. We will be using the same email address you logged into the Work-Learn Classroom to contact you for scheduling.</li></ol><p>We will be on campus at SFH _________________ and will make every effort to schedule a time to meet with you in person while we're here. If this isn't possible, one of our team members will be contacting you by email to schedule a time to meet virtually using an online communications platform (zoom).</p><p>Finally, we know that your time is valuable, and we truly appreciate all of your efforts as you work your way through the program. For this reason, you will be given $_______ for each of the three meetings you have with us.</p><p>If you have any questions before you get started, please direct those questions by email to <a href='mailto:worklearnproject@gmail.com'>worklearnproject@gmail.com</a>.</p>",
      },
      {
        id: 2,
        name: "GS Module 1.1: Basic Computer and Digital Literacy Practice",
        content: `
            <h1>What is Computer Literacy?</h1>
            ...
            <h1>What is Digital Literacy?</h1>
      ...
      },
      {
        ...
        content: `
    <h1>Before You Proceed to Other Modules</h1>
